About napari-workflow-inspector
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-workflow-inspector-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15302&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-workflow-inspector-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-workflow-inspector` can be installed with:

```
conda install napari-workflow-inspector
```

It is possible to list all of the versions of `napari-workflow-inspector` available on your platform with:
